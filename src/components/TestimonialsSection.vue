      ...
      <div class="row gy-4 pt-lg-5 pt-0">
        <div class="col-12 col-lg-6">
          ...
          <div class="d-flex align-items-center gap-3">
            <img
              src="../assets/testimonial-avatar-1.svg"
              class="img-fluid"
              alt="testimonial avatar 1"
            />
            <div>
              <h6 class="fw-bold m-0">Gabriel Valdivia</h6>
              <p class="m-0 text-muted">Principal Product Designer, Patreon</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6">
          ...
          <div class="d-flex align-items-center gap-3">
            <img
              src="../assets/testimonial-avatar-2.svg"
              class="img-fluid"
              alt="testimonial avatar 2"
            />
            <div>
              <h6 class="fw-bold m-0">Buzz Usborne</h6>
              <p class="m-0 text-muted">Principal Designer, Buildkite</p>
            </div>
          </div>
        </div>
      </div>
